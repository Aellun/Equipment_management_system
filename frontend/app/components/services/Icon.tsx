...
const SERVICE_ICONS: Record<string, string> = {
  ...
  laundry: "shirt",
  "gift-delivery": "gift",
  "market-sourcing": "shopping-bag",
  "bank-run": "banknote",
  "document-courier": "file-text",
  "huduma-queue": "landmark",
  "ntsa-plates": "car",
  "passport-docs": "id-card",
  "property-check": "home",
  "bill-payment": "receipt",
  "hospital-checkin": "heart-pulse",
  ...
  "nappy-bin-service": "trash",
  "laundry-wash-fold": "shirt",
  "laundry-duvets": "shirt",
  "ironing-service": "shirt",
  "dry-cleaning": "shirt",
  "linen-rental": "shirt",
  "office-deep-clean": "sparkles",
  "washroom-hygiene": "droplet",
  "water-dispenser-clean": "droplet",
  "sanitizer-dispenser": "droplet",
  "waste-collection": "trash",
  fumigation: "bug",
  "hygiene-subscription": "receipt",
};

const CATEGORY_ICONS: Record<string, string> = {
  "Everyday Errands": "shopping-cart",
  "Government & Bureaucracy": "landmark",
  "Banking & Documents": "banknote",
  "Diaspora Support": "home",
...
export function serviceIconName(service?: { slug?: string; category?: string } | null): string {
  if (!service) return "package";
  return (
    (service.slug && SERVICE_ICONS[service.slug]) ||
...
export function Icon({
  ...
  const children = PATHS[name] || PATHS.package;
  return (
    <svg

    ...
    <div className="space-y-5">
      ...
      {categories.length === 0 ? (
        <div className="text-center py-16 bg-white border border-slate-200 rounded-2xl">
          ...
          <p className="text-sm text-slate-400 mt-1">Add one to organise your equipment inventory</p>
        </div>
      ) : (
        <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
          {categories.map((cat) => (
            <div
              key={cat.id}
              className="bg-white border border-slate-200 rounded-2xl p-5 flex items-start justify-between gap-3 group hover:border-brand-300 hover:shadow-card-hover transition-all"
            >
          ...
          <div className="bg-white border border-slate-200 rounded-2xl shadow-xl w-full max-w-sm animate-fadeIn">
            <div className="px-6 py-6 text-center">
              ...
              <p className="text-sm text-slate-500">
                Are you sure you want to delete <strong className="text-slate-700">{deleteTarget.name}</strong>? This cannot be undone.
              </p>
            </div>
